...
var handler = function handler(route) {
  ...
  return function () {
    var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(request, reply) {
      var errorFormatter, _ref6, schema, context, rootValue, pretty, graphiql, customFormatError, additionalValidationRules, validationRules, payload, showGraphiQL, _getGraphQLParams, query, variables, operationName, _result, _error$output$statusC, statusCode, errors;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 24:
              ...
              if (_result && _result.errors) {
                _result.errors = _result.errors.map(errorFormatter);
              }

              // If allowed to show GraphiQL, present it instead of JSON.
              if (showGraphiQL) {
                reply((0, _renderGraphiQL2.default)({ query: query, variables: variables, operationName: operationName, result: _result })).type('text/html');
              } else {
                // Otherwise, present JSON directly.
                reply((0, _stringify2.default)(_result, null, pretty ? 2 : 0)).type('application/json');
              }
              _context4.next = 35;
              break;
